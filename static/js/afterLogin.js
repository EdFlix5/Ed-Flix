const singleCardWidth = document.querySelector(".card") == null ? 1 : document.querySelector(".card").offsetWidth;
...
const mostViewedCardNumber = document.querySelectorAll(".card-mostvisited").length;
